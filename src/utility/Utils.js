...
export const getImageServer = obj => {
...
export const selectThemeColors = theme => ({
  ...
  colors: {
    ...theme.colors,
    primary25: '#0035921a', // for option hover bg-color
    primary: '#003592', // for selected option bg-color
    neutral10: '#003592', // for tags bg-color
